...
Revision ID: 80f8be14861
Revises: None
Create Date: 2016-10-19 00:11:47.413524

"""

# revision identifiers, used by Alembic.
revision = '80f8be14861'
down_revision = None
...
def upgrade():
    ...
    op.create_table('sale_item',
        ...
        sa.Column('description_text', sa.UnicodeText(), nullable=False),
        sa.Column('description_html', sa.UnicodeText(), nullable=False),
        sa.Column('blurb_text', sa.UnicodeText(), nullable=False),
        sa.Column('blurb_html', sa.UnicodeText(), nullable=False),
        sa.Column('name', sa.Unicode(length=250), nullable=False),
        sa.Column('title', sa.Unicode(length=250), nullable=False),
        sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(), nullable=False),
    ...
    op.create_table('inventory_item_sale_item',
        ...
        sa.PrimaryKeyConstraint('sale_item_id', 'inventory_item_id')
    )
    op.create_index(op.f('ix_inventory_item_sale_item_inventory_item_id'), 'inventory_item_sale_item', ['inventory_item_id'], unique=False)
